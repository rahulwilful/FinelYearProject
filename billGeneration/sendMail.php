<?php 
include 'sendMail2.php';


//code to sendToAll.php
/* 
<?php
include 'connect.php';
                      ...
                      <?php
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                try {
                                                    ...
                                                    $mail->Body = "Name: $name <br> Customer ID: $id <br> Reading: $reading Litres<br> Address: $address <br> Bill Amount: $cost Rs <br> Due Date: $futureDate <br> Payment Gateway : $payment";
